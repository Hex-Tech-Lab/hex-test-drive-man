      ...
      - generic [ref=e22]:
        ...
        - generic [ref=e33]:
          - link "Next.js 15.4.10 (outdated) Webpack" [ref=e34] [cursor=pointer]:
            ...
            - img [ref=e35]
            - generic "An outdated version detected (latest is 16.1.1), upgrade is highly recommended!" [ref=e37]: Next.js 15.4.10 (outdated)
            - generic [ref=e38]: Webpack
          - img
      - generic [ref=e39]:
        - dialog "Runtime TypeError" [ref=e40]:
          - generic [ref=e43]:
            - generic [ref=e44]:
              - generic [ref=e45]:
                - generic [ref=e47]: Runtime TypeError
                - generic [ref=e48]:
                  ...
                  - link "Learn more about enabling Node.js inspector for server code with Chrome DevTools" [ref=e55] [cursor=pointer]:
                    ...
                    - img [ref=e56]
              - paragraph [ref=e65]: Cannot read properties of undefined (reading 'call')
            - generic [ref=e68]:
              - paragraph [ref=e69]:
                - text: Call Stack
                - generic [ref=e70]: "18"
              - button "Show 18 ignore-listed frame(s)" [ref=e71] [cursor=pointer]:
